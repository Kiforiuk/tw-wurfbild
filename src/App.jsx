    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <div className="fixed top-0 left-0 right-0 bg-slate-900/95 backdrop-blur border-b border-slate-700 z-50 p-2 md:p-6">
        <div className="max-w-7xl mx-auto space-y-2 md:space-y-4">
          ...
          <div className="flex items-center justify-between gap-2 md:gap-4">
            ...
            <div className="w-12 md:w-20">
              <img
                ...
                alt="HSG Logo"
                className="h-9 md:h-16 w-auto rounded"
                onError={(e) => e.target.style.display = 'none'}
              />
            </div>

            {/* Center Title */}
            <h1 className="text-base md:text-3xl font-bold text-blue-400 text-center flex-1">🏐 TW Analyse</h1>
          ...
          {/* Row 2: Action Buttons - full width on mobile, row on desktop */}
          <div className="flex flex-col md:flex md:flex-row md:gap-3 gap-2">
            <button
